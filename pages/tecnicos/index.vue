  ...
  <div>
    ...
    <div class="flex justify-between items-center mb-6">
      <div>
        ...
        <p class="text-gray-600 mt-1">Gestiona el equipo de trabajo del taller</p>
      </div>
      <NuxtLink
        to="/tecnicos/nuevo"
    ...
    <!-- Empty state -->
    <div v-else-if="tecnicos.length === 0" class="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
      <i class="ri-user-settings-line text-5xl text-gray-300 mb-3 block"></i>
      <h3 class="text-lg font-medium text-gray-700 mb-1">No hay técnicos activos</h3>
      <p class="text-gray-500 text-sm mb-4">Agrega tu primer técnico para comenzar</p>
      <NuxtLink
        to="/tecnicos/nuevo"
      ...
      >
        ...
        <div class="p-5 border-b border-gray-100">
          <div class="flex items-start justify-between">
            <div class="flex items-center gap-3">
              <div class="w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center text-white font-semibold text-lg shadow-sm">
                {{ tecnico.nombre.charAt(0).toUpperCase() }}
              </div>
              <div>
                <h3 class="font-semibold text-gray-900">{{ tecnico.nombre }}</h3>
        ...
        <div class="p-5 space-y-3">
          <div class="flex items-center gap-2 text-sm">
            ...
            <span class="text-gray-600">{{ tecnico.telefono || 'Sin teléfono registrado' }}</span>
          </div>
          <div class="flex items-center gap-2 text-sm">
        ...
        <!-- Card footer -->
        <div class="px-5 py-3 bg-gray-50 rounded-b-xl border-t border-gray-100">
          <NuxtLink
        ...
        <div class="relative bg-white rounded-xl shadow-xl max-w-md w-full p-6 transform transition-all">
          <div class="text-center">
            ...
            <div class="mx-auto flex items-center justify-center h-14 w-14 rounded-full bg-orange-100 mb-4">
              <i class="ri-user-unfollow-line text-2xl text-orange-600"></i>
            </div>
